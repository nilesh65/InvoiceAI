...
Extract the data and provide only the JSON object.`;
        ...
        res.status(500).json({
            message: "Failed to parse invoice data from text.", details: error.message
        })
    }
}
...
const generateReminderEmail = async (req, res) => {
    ...
    try {
        ...
        console.error("Error while generating reminder email with AI:", error);
        res.status(500).json({
            message: "Failed to parse invoice data from text.", details: error.message
        })
    }
...
`
        ...
        console.error("Error in getting dashboard summary with AI:", error);
        res.status(500).json({
            message: "Failed to parse invoice data from text.", details: error.message
        })
    }
...
module.exports = { getDashboardSummary, parseInvoiceFromText, generateReminderEmail }